...
module.exports.setRoutes = function(app, sessionVerificationFunc) {
    ...
    /**
     * @api {get} /reports/cost/trends&filterBy=organizationId:<organizationId>&period=<period>&timeStamp=<endDate>&splitUpBy=<catalystEntityType>&interval<INTERVAL>
     * 										                    									Get aggregate cost
     * @apiName generateCostReports
     * @apiGroup reports
     * @apiVersion 1.0.0
