                                                                            ...
                                                                            (function(team) {
                                                                                ...
                                                                                for (var p = 0; p < projectIds.length; p++) {
                                                                                    if (projectIds[p] !== "") {
                                                                                        ...
                                                                                        if (orgCount === orgs.length && bgCount === bgs.length && teamCount === teams.length && projectCount === checkDuplicateProjectList.length && environmentCount === checkDuplicateEnvList.length) {
                                                                                            loopCount++;
