						...
						(function(provider) {
							unManagedInstancesDao.getByOrgProviderId({
								...
								instancesDao.getByOrgProviderId({
									...
									//TODO Cleanup needed
									var ec2ConfigParams = new Object();
									var ec2;

									if(provider.isDefault == true) {
										ec2ConfigParams.isDefault = true;
									} else {
										...
										cryptography.decryptMultipleText(keys, cryptoConfig.decryptionEncoding, cryptoConfig.encryptionEncoding, function(err, decryptedKeys) {
											if (err) {
												...
												ec2ConfigParams.access_key = decryptedKeys[0];
												ec2ConfigParams.secret_key = decryptedKeys[1];
											}
										});
									}
									...
									for (var k = 0; k < regions.length; k++) {
										(function (region) {
											ec2ConfigParams.region = region;
											var ec2 = new EC2(ec2ConfigParams);
