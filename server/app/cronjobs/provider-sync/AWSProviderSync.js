                                                            ...
                                                            for (var l = 0; l < reservations.length; l++) {
                                                                ...
                                                                if (reservations[l].Instances && reservations[l].Instances.length) {
                                                                    ...
                                                                    for (var m = 0; m < awsInstances.length; m++) {
                                                                        ...
                                                                        if (projectTag && environmentTag && (awsInstances[m].State.Name !== 'terminated') && (projectTag.name in tagInfo) && (environmentTag.name in tagInfo)) {
                                                                        ...
                                                                        if (!found) {
                                                                            for (var n = 0; n < unManagedInstances.length; n++) {
                                                                                if ((unManagedInstances[n].platformId === awsInstances[m].InstanceId) && !assignmentFound) {
