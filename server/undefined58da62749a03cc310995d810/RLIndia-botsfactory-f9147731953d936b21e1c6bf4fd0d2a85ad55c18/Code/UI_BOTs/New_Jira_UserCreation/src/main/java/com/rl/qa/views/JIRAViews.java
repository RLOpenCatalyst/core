...
public class JIRAViews {
    ...
    public static void clickOnAdministrationlink(){
        try {
//            Thread.sleep(1000);
            SeleniumUtil.waitForElementIsClickable("id", "admin_menu",2, SeleniumUtilities.OBJWAITTIMEOUT);
    ...
    public static void clickOnUserManagementOption()
    {
        try {
            Thread.sleep(2000);
            SeleniumUtil.waitForElementIsClickable("id", "user_management_section",2, SeleniumUtilities.OBJWAITTIMEOUT);
    ...
    public static void clickonCreateUsersButton()
    {
        try {
            Thread.sleep(2000);
            SeleniumUtil.waitForElementIsClickable("id", "new-user-quick-add-submit", 2, SeleniumUtilities.OBJWAITTIMEOUT);
    ...
    public static void clickOnUnwantedPopup()
    {
        try {
            Thread.sleep(2000);
            SeleniumUtil.waitForElementIsClickable("xpath", "(//span[@class='aui-icon icon-close'])[1]",2, SeleniumUtilities.OBJWAITTIMEOUT);
