			...
			$scope.initGrids = function(){
				...
				data : 'tabData',
					columnDefs : [
						...
						'<span class="containerIcon greenBg" ng-click="grid.appScope.containerAction(row.entity,1)" id="start"  title="Start" ng-show="grid.appScope.checkEdited(row.entity)"><i class="fa fa-play white"></i></span>'+
