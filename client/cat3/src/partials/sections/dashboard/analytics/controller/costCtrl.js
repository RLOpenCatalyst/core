          ...
          costObj.createChart = function(fltObj) {
                ...
                costObj.costGridOptions = {
                    ...
                    genSevs.promiseGet(param).then(function (result) {
                        ...
                        costObj.barChat.data[0].values=[];
                        costObj.barChat.data[1].values=[];
                        costObj.barChat.data[2].values=[];
                        if(fltObj.provider){
                            angular.forEach(result.splitUpCosts.providers,function (valu) {
                                ...
                                costObj.barChat.data[0].values.push({
                                    "label": valu.name,
                                    "value": valu.cost.awsCosts.serviceCosts.ec2
                                });
                                costObj.barChat.data[1].values.push({
                                    "label": valu.name,
                                    "value": valu.cost.awsCosts.serviceCosts.rds
                                });
                                costObj.barChat.data[2].values.push({
                                    "label": valu.name,
                                    "value": valu.cost.awsCosts.serviceCosts.s3
                                });
                            });
                        } else {
