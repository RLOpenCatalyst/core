                                ...
                                angular.forEach($scope.taskHistoryData.data, function(val){
                                    ...
                                    if(auditType === 'chef' || auditType === 'script') {
                                        var chefGrid = [
                                            ...
                                            { name:'Reference',cellTemplate:'<span title="{{row.entity.auditTrailConfig.serviceNowTicketRefObj.ticketLink}}"><a href="{{row.entity.auditTrailConfig.serviceNowTicketRefObj.ticketLink}}" target="_blank">{{row.entity.auditTrailConfig.serviceNowTicketRefObj.number}}</a></span>', sort:{ direction: 'desc'}, cellTooltip: true},
