                                ...
                                angular.forEach($scope.taskHistoryData.data, function(val){
                                    ...
                                    if(auditType === 'chef' || auditType === 'script') {
                                        ...
                                        var jenkinsGrid = [
                                            ...
                                            { name:'Job Output',width: 100,cellTemplate:'<span><a target="_blank" title="{{jobResultUrlName}}" class="fa fa-file-text bigger-120 btn cat-btn-update btn-sg tableactionbutton marginbottomright3" ng-repeat="jobResultUrlName in row.entity.auditTrailConfig.jobResultURL" ng-href="{{jobResultUrlName}}"></a></span>',cellTooltip: true},
                                    ...
                                    } else if (auditType === 'instance_launch' || auditType === 'aws_cf' || auditType === 'docker' || auditType === 'azure_launch') {
                                        var blueprintGrid = [
                                            { name:'Status',field:'status',cellTemplate:'<div class="{{row.entity.status}}">{{row.entity.status}}</div>', cellTooltip: true},
                                            { name:'User',field:'user',cellTooltip: true},
                                            { name:'Logs',width: 70,
